...
class docente_ccaController extends Controller {
    ...
    public function index() {
        ...
        $data['grilla'] = $this->grilla("docente_cca", $cols, $data['data']['rows'], $opt, $data['pag'], true, true);
   ...
   public function edit() {
    ...
    public function buscar() {
        ...
        $data['grilla'] = $this->grilla("docente_cca", $cols, $data['data']['rows'], $opt, $data['pag'], false, false, true, true);
