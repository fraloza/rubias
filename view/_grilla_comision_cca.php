    ...
    <thead>
        <tr>
            ...
            <th ><?php echo strtoupper($c); ?></th>
             <?php }
            if($pension){echo '<th>&nbsp</th>';}
            if($requisitos){echo '<th>&nbsp;</th>';}
            if($detallar){echo '<th>&nbsp;</th>';}
            if($edit) {echo '<th >&nbsp;</th>';}
            if($view) {echo '<th >&nbsp;</th>';}
         ...
         foreach ($rows as $value) { 
          $n ++;
           ...
           if($value['Estado']=='Falta'){  $myselect .= ")'><img src='images/front.png' /></a></td>";}
            ...
            if($pension) 
              {  if($presidente){echo "<td align='center' width='5%'><a href='index.php?controller=concepto_pension_cca&id=$value[0]' title='Ver Requisitos'><img alt='' src='images/marker_1.gif' /></a> </td>";}
                  else{
                            if($value['estado_modo_vista']==false){
                          ?>
                              <td align="center" width="5%" ><a href="index.php?controller=concepto_pension_cca&id=<?php  echo $value[0]; ?>" title="Ver Requisitos"><img alt="" src="images/marker_1.gif" /></a></td>
                          <?php
                        }
            ...
            if($requisitos) 
              {  if($presidente){echo "<td align='center' width='5%'><a href='index.php?controller=requisitos_cca&id=$value[0]' title='Ver Requisitos'><img alt='' src='images/marker_1.gif' /></a> </td>";}
                  else{
                            if($value['estado_modo_vista']==false){
                          ?>
                              <td align="center" width="5%" ><a href="index.php?controller=requisitos_cca&id=<?php  echo $value[0]; ?>" title="Ver Requisitos"><img alt="" src="images/marker_1.gif" /></a></td>
                          <?php
                        }
                        else{echo "<td><img  src='images/error.png' title='No Editable' /></td>";}
                    }
            ...
            if($detallar) 
              {  if($presidente){echo "<td align='center' width='5%'><a href='index.php?controller=detalle_comision_cca&id=$value[0]' title='Ver Miembros'><img alt='' src='images/add.png' /></a> </td>";}
                  else{
                            if($value['estado_modo_vista']==false){
                          ?>
                              <td align="center" width="5%" ><a href="index.php?controller=detalle_comision_cca&id=<?php  echo $value[0]; ?>" title="Ver Miembros"><img alt="" src="images/add.png" /></a></td>
                          <?php
                        }
                        else{echo "<td><img  src='images/error.png' title='No Editable' /></td>";}
                    }
