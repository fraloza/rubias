...
<!--        <input type="submit" value="Buscar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover"   />-->
     ...
     <?php if($new) { ?>
        <a href="index.php?controller=<?php echo $name; ?>&action=create&cod=<?php echo $cod;?>" class="button"  > Nuevo </a>
        <?php } ?>
        <?php // } ?>  
        </div>       
    </form>
...
<table id="datatables" class="display" style="width: 100%;">
    ...
    <?php echo $pag; ?><a href="index.php?controller=comision_cca" class="button">ATRAS</a>
