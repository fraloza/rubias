...
<button onclick="javascript:popup('index.php?controller=alumno_cca&action=buscar',860,400);">BUSCAR</button>
             ...
             <fieldset class="ui-corner-all" >
                <legend>Accion</legend> 
                 <div  style="clear: both; padding: 10px; width: auto;text-align: center">
                    ...
                    <a href="index.php?controller=alumno_cca" class="button">ATRAS</a>
                 </div>   
              </fieldset>
              </div>
        </div>
