...
class Controller {
    ...
    //-------------------------------------------------------------------------------------------------------
    //-------------------------------------------------------------------------------------------------------
      public function grilla_detcom_cca($name, $cod,$columns, $rows, $options, $pag, $edit, $view, $select = false, $new = true,$asig,$chek,$presidente) {
        $obj = new Main();
        $data = array();
        $data['nr'] = $obj->getnr();
        $data['cod']=$cod;
        ...
        $view = new View();
        $view->setData($data);
        $view->setTemplate('../view/_grilla_detcom_cca.php');
    ...
    public function grilla_comision_cca($name, $columns, $rows, $options, $pag,$pension,$requisitos, $detallar,$edit, $view, $select = false, $new = true,$asig,$chek,$presidente) {
        $obj = new Main();
        $data = array();
        $data['nr'] = $obj->getnr();
        $data['cols'] = $columns;
        ...
        $view = new View();
        $view->setData($data);
        $view->setTemplate('../view/_grilla_comision_cca.php');
        $view->setLayout('../template/Layout.php');
        return $view->renderPartial();
    }
